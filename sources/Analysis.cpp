...
Analysis::Analysis(std::string &dirPath)
{
    try {
        _path = path(dirPath);
...
void Analysis::AccPush(const account& tempAcc)
{
    for (auto& x : _trader)
    {
...
void Analysis::PathAnalyze(const directory_entry& dirEntry)
{
...
bool Analysis::isNumber(const std::string& fileNamePart)
{
...
bool Analysis::NameAnalyze(const path& filePath) {
...
void Analysis::FileAnalyze(const path& filePath)
{
...
void Analysis::DirAnalyze(const directory_entry& dirPath)
{
